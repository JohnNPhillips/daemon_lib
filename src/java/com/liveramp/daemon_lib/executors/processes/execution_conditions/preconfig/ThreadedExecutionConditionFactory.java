...
public class ThreadedExecutionConditionFactory implements ConfigurableFactory<ExecutionCondition> {
  ...
  public ThreadedExecutionConditionFactory(ProcessController<?, ?> controller, int defaultMaxProcesses) {
